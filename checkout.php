...
<head>
    ...
    <title>SEGECOM-EX - Venta de piezas industriales y servicios de mantenimiento</title>
...
<body class="d-flex flex-column h-100">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn-elimina" class="btn btn-danger">Eliminar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        eliminaModal.addEventListener('show.bs.modal', function(event) {
            ...
            // Extraer el ID del producto del atributo data-producto-id
            productoIdAEliminar = button.getAttribute('data-producto-id')
        })
        ...
        function elimina() {
            if (productoIdAEliminar) {
                ...
                formData.append('id', productoIdAEliminar);
        ...
        // Asignar la función eliminar al botón del modal
        document.getElementById('btn-elimina').addEventListener('click', elimina);
